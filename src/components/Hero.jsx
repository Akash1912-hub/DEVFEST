...
function Hero() {
  ...
  <div className="mx-[5vw] md:mx-[10vw] my-[10vw] md:my-36 md:flex relative">
    <div className="grow">
      <div className="relative">
        {/* Main Title */}
        <h1
          ref={titleRef}
          className="font-black text-5xl md:text-7xl lg:text-[12vw] z-10 relative glitch-text"
        >
          DEVFEST'24
        </h1>
        {/* Glitch Layers */}
        <div
          ...
          className="glitch-layer text-5xl md:text-7xl lg:text-[12vw] text-red-500 absolute top-0 left-0"
        >
          DEVFEST'24
        </div>
        <div
          ref={(el) => (glitchLayers.current[1] = el)}
          className="glitch-layer text-5xl md:text-7xl lg:text-[12vw] text-blue-500 absolute top-0 left-0"
        >
          DEVFEST'24
        </div>
      </div>
      ...
      <p
        ref={subTitleRef}
        className="md:text-3xl lg:text-4xl opacity-50 w-[80%] md:w-[70%] lg:w-[50%]"
      >
        Brought to you by DEVS REC
      </p>
    </div>
    <div className="flex md:inline gap-[10vw] text-sm mt-20 md:mt-0">
